...
Published runtime: **[0.35.1-beta.1](https://github.com/jonioliel/home-assistant-hikvision-intercom/releases/tag/v0.35.1-beta.1)** — station card capture directly in the user Cards editor alongside USB entry. Includes mobile phones and compact header navigation from 0.35.0. [Card capture instructions](docs/STATION_CARD_EDITOR_HE.md), [verified checks](docs/VALIDATION.md). Beta prerelease; physical commissioning remains open.
