...
## נקודות ייחוס — חדש ב־0.16

אחרי בדיקת התאמה אפשר לשמור נקודת ייחוס ולהשוות קריאות עתידיות, כולל שינוי בתוכן
ללא שינוי בספירות. הקריאות החלקיות נשארות חלקיות. [מדריך השוואה ושמירה](SCHEDULE_BASELINES.md).
