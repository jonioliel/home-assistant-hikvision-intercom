# עיצוב חלופי למערכת — תכנון מאושר ומימוש

תאריך: 2026-09-10. בסיס המוצר: 0.27.7-alpha.1, קוד `fc70d20`.
מצב: **אושר למימוש ב־2026-09-10**. הבעלים אישר את ההדמיות וביקש התאמה לכל רוחבי המסך.
[מסירת המימוש 0.28.0](../ALTERNATE_UI_028_HE.md) כוללת את ההחלטות, ההתאמות והבדיקות בפועל.
...
הבקשה המקורית אישרה הכנת הדמיות; הודעת ההמשך אישרה להתחיל במימוש.
...
| C-ALT-02 | הדמיות מחשב, נייד, כהה ובחירת עיצוב | הושלם ואושר | תמונות עקביות, נתוני דוגמה והערות לבחינה. |
| C-ALT-03 | משוב ואישור הכיוון | אושר על ידי הבעלים | בחינת צפיפות, ניווט, עריכה ובורר העיצוב; תיקון ההדמיה לפי המשוב. |
| C-ALT-04 | תשתית שתי חלופות ושמירת העדפה | מומש ונבדק | הקיים כברירת מחדל, בחירה נשמרת, ללא שינוי נתונים או שליחת פקודות. |
| C-ALT-05 | סקירה, מצלמה ושיחה בעיצוב החדש | מומש ונבדק | אותה לוגיקה של תחנות/מדיה; תצוגה צפופה ועצמאות פעולות. |
| C-ALT-06 | משתמשים ועריכה | מומש ונבדק | טבלה/כרטיסים, הרשאות, PIN וכרטיסים ושמירה מלאה של היכולות. |
| C-ALT-07 | תחנות, אירועים, סנכרון ויומן | מומש ונבדק | שפה אחידה, ניווט לבירור בעיות ושימור הכלים הקיימים. |
| C-ALT-08 | כלים מתקדמים והשלמת שתי החלופות | מומש ונבדק | נגישות לאבחון ולתכנון בשתי התצוגות, ללא שכתוב מנגנוני ISAPI. |
| C-ALT-09 | בדיקות שימוש, נגישות ורגרסיה | מומש ונבדק | 390/768/1440, RTL/LTR, בהיר/כהה, החלפה עם טיוטה/וידאו/פעולה ממתינה. |
| C-ALT-10 | תיעוד ופרסום | בבדיקות שחרור | גרסה סמנטית מתאימה, CHANGELOG, בדיקות שחרור, GitHub Release ו־HACS. |
...
ב־2026-09-10 התקבל אישור מפורש: ״זה נראה נפלא ... תתחיל במימוש ... למחשב לטאבלט לנייד״.
הסעיפים להלן שומרים את ההצעה המקורית; ההבדלים והמימוש העדכני מתועדים
ב־[דוח המסירה](../ALTERNATE_UI_028_HE.md), כולל בחירת ניווט עליון בנייד.
...
6. לאחר אישור הבעלים מומשו בורר מראה, סגנון חלופי ופריסות תלויות רוחב, ונוספו בדיקות
   רגרסיה וצילומי מוצר. פיתוח המראה אינו מעלה את מדדי הקבלה הפיזית.
