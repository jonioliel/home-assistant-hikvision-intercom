...
- קומיט תיקוני הזהות: `a5d0a145cfbc5c09c894479fc6a26535ef6863d3`.
  ...
  בדיקות הקוד לא נכשלו שם. לאחר שהתקלה חזרה גם במועמדת, תהליך CI עודכן להסרת
  מקור APT של Chrome ממכונת הבדיקה הזמנית לפני התקנת תלויות Playwright.
  Chromium מותקן על ידי Playwright; בדיקות הדפדפן המלאות נשארות תנאי לפרסום.
...
פורסמה [v0.24.0-alpha.1](https://github.com/jonioliel/home-assistant-hikvision-intercom/releases/tag/v0.24.0-alpha.1)
מהקומיט `124abaa4aacbe5ad29c5b32b4e14a3663f145365`. מימוש הממשק והכנת הגרסה:
`e5460999293d8a05c9d27d93082ddf51ecac0f1a`; תיקוני זהות: `a5d0a14`.

[הרצת הפרסום 34387022883](https://github.com/jonioliel/home-assistant-hikvision-intercom/actions/runs/34387022883)
עברה בכל שבע העבודות: 838 בדיקות Python בכל אחת מגרסאות 3.12/3.14,
238 בדיקות HA (100% כיסוי ConfigFlow), 134 בדיקות דפדפן, mypy ל־56 קבצים,
Ruff, TypeScript, Prettier, שחזור bundle, HACS ו־Hassfest.

לאחר הפרסום אומתו התג מול קומיט הפרסום, גרסת manifest, קובצי המקור והמסירה,
חבילת הממשק בגודל 1,034,672 בתים והיעדר תיקיות מידע פרטי בתג. הגרסה מסומנת prerelease
וזמינה במסלול HACS הקיים. אימות התג אינו בדיקת התקנה במערכת הבעלים.
