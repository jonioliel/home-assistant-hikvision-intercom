const en = {
  ...
  lifecycle_intro:
    "Review access that needs attention before it becomes an operational or security issue.",
  lifecycle_warning_days: "Expiry warning horizon (days)",
  lifecycle_refresh: "Refresh",
  lifecycle_export: "Export safe report",
  lifecycle_generated: "Report generated",
  lifecycle_total: "People",
  lifecycle_active: "Active",
  lifecycle_expiring: "Expiring soon",
  lifecycle_expired: "Expired",
  lifecycle_duplicate_users: "Possible duplicates",
  lifecycle_without_credentials: "Without credentials",
  lifecycle_expirations: "Expiry and upcoming changes",
  lifecycle_duplicates: "Possible duplicate records",
  lifecycle_missing_credentials: "Active people without an access method",
  lifecycle_none: "No records need attention.",
  lifecycle_open_user: "Open person",
  lifecycle_status_expiring: "Expiring",
  lifecycle_status_expired: "Expired",
  lifecycle_reason_display_name: "Same normalized name",
  ...
  lifecycle_duplicate_confirm:
    "WisKey found {count} possible existing person record(s). Review them in Identity lifecycle. Save this person anyway?",
  ...
  station_tab_programs: "Opening schedules",
  station_tab_public_codes: "Public codes",
  station_tab_settings: "Settings",
  public_codes_readonly:
    "This interface reports configured slots, not PIN digits. Adding, replacing or deleting public codes is unavailable until a supported write interface is verified.",
  public_code_slot: "Public code",
  programs_title: "Opening schedules",
  ...
  program_held_acknowledged: "Hold-open command acknowledged; physical state not verified.",
  program_restoring: "Returning to normal control",
  program_unknown: "Command outcome unknown; restoration pending.",
  program_checked: "Last transition recorded",
  program_times: "Days and times",
  program_start: "Start",
  program_end: "End",
  program_dates: "Specific dates / exceptions",
  program_legacy: "Previously saved, not activated. Open to edit and activate explicitly.",
  ...
  operation_saved: "Saved centrally",
  api_incompatible:
  ...
  onboarding_name: "Template name",
  onboarding_new: "New template",
  onboarding_add: "Add onboarding template",
  onboarding_template: "Onboarding template",
  onboarding_apply: "Apply defaults to draft",
  onboarding_apply_hint:
    "Replaces this draft’s profile, groups and personal exceptions. Review the doors before saving the new person.",
  profile_field_type: "Field type",
  profile_field_required: "Required for new values",
  profile_type_text: "Text",
  profile_type_select: "Closed list",
  profile_type_number: "Number",
  profile_type_date: "Date",
  profile_legacy_hint:
    "Existing values are preserved when a field definition changes. New or changed values are validated; revoking access remains available.",
  profile_legacy_value: "existing value",
  profile_required: "Complete required profile fields.",
  profile_value_invalid: "A profile value does not match its field type or allowed options.",
  policy_review: "Review group permission changes",
  policy_review_hint:
    "Review who gains or loses access. Personal exceptions are preserved. Saving queues synchronization; it does not confirm physical access.",
  policy_apply: "Apply reviewed policy",
  before: "Before",
  after: "After",
  personal_overrides: "Personal exceptions",
  permission_directory: "Door permissions",
  tools_permission_directory:
    "Who has access, group sources, personal exceptions and synchronization.",
  permission_directory_hint:
    "Current central policy, not proof of device enforcement. Pending and applied revisions are shown separately.",
  permission_directory_mode: "Show",
  permission_directory_allowed: "Access allowed by policy",
  permission_directory_all: "All people",
  permission_directory_exceptions: "Personal exceptions",
  permission_directory_load: "Generate permission report",
  ...
  audio_received_signal: "Signal received from station",
  audio_received_peak: "Peak signal received from station",
  audio_microphone_signal_written: "Non-silent microphone bytes written",
  audio_received_signal_bytes: "Non-silent station bytes received",
  ...
  tts_message: "Announcement text",
  tts_placeholder: "Type a message to speak at this station…",
  tts_send: "Speak at station",
  ...
  tts_cancelled: "The announcement was stopped.",
  ...
  access_list_options: "Filters and saved views",
  access_attention: "Needs attention",
  lock_enabled: "Managed door",
  access_recent_activity: "Latest access per station",
  appearance: "Appearance",
  appearance_choose: "Panel design",
  appearance_current: "Existing",
  appearance_modern: "New",
  appearance_apply: "Apply design",
  appearance_hint: "Choose a design. Personal choices are saved for this user in this browser.",
  "appearance_access-light": "WisKey Access · Light",
  "appearance_access-dark": "WisKey Access · Dark",
  "appearance_wiskey-light": "WisKey 04 · Light",
  "appearance_wiskey-dark": "WisKey 04 · Dark",
  wk4_entry_center: "Entry center",
  wk4_entry_intro: "Doors, people and work that needs attention",
  wk4_camera_wall: "Camera wall",
  wk4_door_filter: "Filter doors",
  wk4_filter_all: "All doors",
  wk4_filter_online: "Connected",
  wk4_filter_attention: "Needs attention",
  wk4_nav_overview: "Entry center",
  wk4_nav_users: "People",
  wk4_nav_devices: "Doors",
  wk4_nav_events: "Activity",
  wk4_nav_tools: "Management",
  wk4_report_actions: "Reports and export",
  wk4_station_programs_hint: "Review and manage scheduled door openings",
  wk4_station_codes_hint: "Review and manage public door codes",
  access_by_permissions: "Access by permissions",
  appearance_follow: "Use the shared default",
  appearance_shared: "Set this design as the shared default for all users",
  appearance_shared_hint:
    "Users with a personal choice keep it. New users and browsers follow the shared default.",
  ...
  audio_start: "Start listening",
  audio_stop: "Stop listening",
  ...
  select_visible_page: "Select users on this page (up to 200)",
  user_pagination: "User directory pages",
  users_per_page: "Users per page",
  user_page_loading: "Refreshing page…",
  ...
  bulk_profile: "Update custom fields",
  ...
  support_bundle_download: "Download support bundle",
  support_bundle_hint:
  ...
  fleet_display: "Display setting",
  fleet_next: "Next change under the sampled device rules",
  fleet_fixed: "Fixed offset; no configured DST",
  fleet_not_computed: "Not computed or needs a fresh sample",
  fleet_different:
    "The sampled devices use different time sources or zone rules. This may be intentional; compare each station below.",
  fleet_stale: "No current measurement; last values shown if available",
  fleet_not_measured: "Uncertainty not measured; drift not assessed",
  fleet_within_tolerance: "Within the 90-second tolerance",
  fleet_uncertain: "Uncertainty overlaps the 90-second threshold",
  fleet_ahead: "Clock ahead by more than 90 seconds in this sample",
  fleet_behind: "Clock behind by more than 90 seconds in this sample",
  fleet_repeated_ahead: "Repeated observations: clock ahead by more than 90 seconds",
  fleet_repeated_behind: "Repeated observations: clock behind by more than 90 seconds",
  ...
  tools_sync: "Pending changes, conflicts and synchronization diagnostics.",
  operations_center: "Background operations",
  tools_operations_center:
    "Live progress for synchronization, imports, group changes and other bulk actions.",
  jobs_title: "Background operations",
  jobs_intro:
    "Durable activity grouped by person and station. One failed station does not hide progress on the others.",
  jobs_summary: "Operation summary",
  jobs_kind: "Operation type",
  job_kind_all: "All operations",
  job_kind_sync: "Synchronization",
  job_kind_bulk: "Bulk changes",
  job_kind_csv: "CSV imports",
  jobs_progress: "Verified progress",
  jobs_retry_user: "Retry person",
  jobs_retry_station: "Retry station",
  jobs_details: "Person and station details",
  jobs_empty: "No operations match the current filters.",
  job_action_sync_user_station: "Person synchronization",
  job_action_bulk_csv_import: "CSV import",
  tools_audit: "Review administrative changes and their outcomes.",
...
const he: Record<keyof typeof en, string> = {
  ...
  lifecycle_intro: "מרכז פריטים שדורשים טיפול לפני שהם הופכים לתקלה תפעולית או לסיכון הרשאות.",
  lifecycle_warning_days: "טווח התרעה לפני תפוגה (ימים)",
  lifecycle_refresh: "רענון",
  lifecycle_export: "ייצוא דוח בטוח",
  lifecycle_generated: "הדוח הופק",
  lifecycle_total: "משתמשים",
  lifecycle_active: "פעילים",
  lifecycle_expiring: "עומדים לפוג",
  lifecycle_expired: "פגי תוקף",
  lifecycle_duplicate_users: "כפילויות אפשריות",
  lifecycle_without_credentials: "ללא אמצעי גישה",
  lifecycle_expirations: "תפוגה ושינויים קרובים",
  lifecycle_duplicates: "רשומות כפולות אפשריות",
  lifecycle_missing_credentials: "משתמשים פעילים ללא אמצעי גישה",
  lifecycle_none: "אין רשומות שדורשות טיפול.",
  lifecycle_open_user: "פתיחת משתמש",
  lifecycle_status_expiring: "עומד לפוג",
  lifecycle_status_expired: "פג תוקף",
  lifecycle_reason_display_name: "שם זהה לאחר נרמול",
  ...
  lifecycle_duplicate_confirm:
    "WisKey מצאה {count} רשומות משתמש קיימות שעשויות להיות כפולות. מומלץ לבדוק אותן במסך מחזור חיי משתמשים. לשמור בכל זאת?",
  ...
  station_tab_public_codes: "קודים ציבוריים",
  station_tab_settings: "הגדרות",
  public_codes_readonly:
    "הממשק מדווח אילו תאים מוגדרים, ולא את ספרות הקוד. הוספה, החלפה ומחיקה אינן זמינות עד לאימות ממשק כתיבה נתמך.",
  public_code_slot: "קוד ציבורי",
  programs_title: "תוכניות פתיחה",
  ...
  program_held_acknowledged: "פקודת הפתיחה אושרה; מצב פיזי לא אומת.",
  program_restoring: "מחזיר לשליטה רגילה",
  program_unknown: "תוצאת הפקודה אינה ידועה; החזרה ממתינה.",
  program_checked: "מעבר אחרון שנרשם",
  program_times: "ימים ושעות",
  program_start: "התחלה",
  program_end: "סיום",
  program_dates: "תאריכים מסוימים / חריגים",
  program_legacy: "נשמרה בעבר ולא הופעלה. פתח לעריכה ולהפעלה מפורשת.",
  ...
  onboarding_name: "שם תבנית",
  onboarding_new: "תבנית חדשה",
  onboarding_add: "הוסף תבנית קליטה",
  onboarding_template: "תבנית קליטה",
  onboarding_apply: "החל ברירות מחדל לטיוטה",
  onboarding_apply_hint:
    "מחליף את השדות, הקבוצות והחריגות האישיות בטיוטה. בדוק את הדלתות לפני שמירת האדם החדש.",
  profile_field_type: "סוג שדה",
  profile_field_required: "חובה בקליטה ובשינוי ערך",
  profile_type_text: "טקסט",
  profile_type_select: "רשימה סגורה",
  profile_type_number: "מספר",
  profile_type_date: "תאריך",
  profile_legacy_hint:
    "ערכים קיימים נשמרים כשמשנים הגדרת שדה. ערכים חדשים או ערכים שמשתנים נבדקים; ביטול גישה נשאר זמין.",
  profile_legacy_value: "ערך קיים",
  profile_required: "יש להשלים את שדות החובה.",
  profile_value_invalid: "ערך בשדה מותאם אינו תואם לסוג השדה או לרשימת האפשרויות.",
  policy_review: "סקירת שינוי הרשאות הקבוצה",
  policy_review_hint:
    "בדוק מי מקבל או מאבד גישה. חריגות אישיות נשמרות. השמירה יוצרת עבודה לסנכרון ואינה מאשרת גישה פיזית.",
  policy_apply: "החל את המדיניות שנסקרה",
  before: "לפני",
  after: "אחרי",
  personal_overrides: "חריגות אישיות",
  permission_directory: "הרשאות לפי דלת",
  tools_permission_directory: "מי מורשה, מקורות מקבוצות, חריגות אישיות ומצב סנכרון.",
  permission_directory_hint:
    "המדיניות המרכזית הנוכחית, ללא טענה לאכיפה פיזית. הגרסה הרצויה והגרסה שהוחלה מוצגות בנפרד.",
  permission_directory_mode: "הצגה",
  permission_directory_allowed: "גישה מותרת לפי המדיניות",
  permission_directory_all: "כל האנשים",
  permission_directory_exceptions: "חריגות אישיות",
  permission_directory_load: "הצגת דוח הרשאות",
  ...
  audio_received_signal: "אות שמתקבל מהתחנה",
  audio_received_peak: "שיא האות שהתקבל מהתחנה",
  audio_microphone_signal_written: "בייטים לא־שקטים שנכתבו לתחנה",
  audio_received_signal_bytes: "בייטים לא־שקטים שנקלטו מהתחנה",
  audio_written: "בייטים של מיקרופון שנכתבו לתחנה",
  ...
  tts_message: "טקסט להקראה",
  tts_placeholder: "הקלד הודעה שתוקרא בתחנה הזו…",
  tts_send: "השמע בתחנה",
  tts_stop: "עצור הקראה",
  tts_engine: "מנוע קול",
  tts_language: "שפה",
  ...
  access_list_options: "מסננים ותצוגות שמורות",
  ...
  appearance_hint: "בחירת עיצוב למערכת. בחירה אישית נשמרת למשתמש בדפדפן זה.",
  "appearance_access-light": "WisKey Access · בהיר",
  "appearance_access-dark": "WisKey Access · כהה",
  "appearance_wiskey-light": "WisKey 04 · בהיר",
  "appearance_wiskey-dark": "WisKey 04 · כהה",
  wk4_entry_center: "מרכז הכניסה",
  wk4_entry_intro: "דלתות, אנשים ופעולות שדורשות תשומת לב",
  wk4_camera_wall: "תצוגת מצלמות",
  wk4_door_filter: "סינון דלתות",
  wk4_filter_all: "כל הדלתות",
  wk4_filter_online: "מחוברות",
  wk4_filter_attention: "דורשות טיפול",
  wk4_nav_overview: "מרכז הכניסה",
  wk4_nav_users: "אנשים",
  wk4_nav_devices: "דלתות",
  wk4_nav_events: "פעילות",
  wk4_nav_tools: "ניהול",
  wk4_report_actions: "דוחות וייצוא",
  wk4_station_programs_hint: "צפייה וניהול של פתיחות דלת מתוזמנות",
  wk4_station_codes_hint: "צפייה וניהול של קודי פתיחה ציבוריים",
  access_by_permissions: "גישה לפי הרשאות",
  appearance_follow: "שימוש בברירת המחדל המשותפת",
  appearance_shared: "הגדרת העיצוב כברירת מחדל לכל המשתמשים",
  appearance_shared_hint:
    "בחירה אישית קיימת נשמרת. משתמשים ודפדפנים חדשים יקבלו את ברירת המחדל המשותפת.",
  appearance_settings_unavailable:
  ...
  audio_start: "פתח האזנה",
  audio_stop: "סגור האזנה",
  ...
  select_visible_page: "בחירת המשתמשים בעמוד זה (עד 200)",
  ...
  bulk_profile: "עדכון שדות מותאמים",
  ...
  support_bundle_download: "הורדת חבילת תמיכה",
  support_bundle_hint:
  ...
  fleet_display: "הגדרת התצוגה",
  fleet_next: "המעבר הבא לפי הכללים שנדגמו מהמכשיר",
  fleet_fixed: "הפרש קבוע; לא מוגדר שעון קיץ",
  fleet_not_computed: "לא חושב או נדרשת דגימה חדשה",
  fleet_different:
    "בתחנות שנדגמו יש מקורות זמן או כללי אזור זמן שונים. הדבר עשוי להיות מכוון; הפרטים לכל תחנה מוצגים למטה.",
  fleet_stale: "אין מדידה עדכנית; מוצגים ערכים קודמים אם קיימים",
  fleet_not_measured: "אי־הוודאות לא נמדדה; החריגה לא הוערכה",
  fleet_within_tolerance: "בתוך סף 90 השניות",
  fleet_uncertain: "טווח אי־הוודאות חוצה את סף 90 השניות",
  fleet_ahead: "השעון מקדים ביותר מ־90 שניות בדגימה זו",
  fleet_behind: "השעון מפגר ביותר מ־90 שניות בדגימה זו",
  fleet_repeated_ahead: "חריגה בדגימות חוזרות: השעון מקדים ביותר מ־90 שניות",
  fleet_repeated_behind: "חריגה בדגימות חוזרות: השעון מפגר ביותר מ־90 שניות",
  ...
  tools_sync: "שינויים ממתינים, התנגשויות ואבחון סנכרון.",
  operations_center: "עבודות רקע",
  tools_operations_center: "התקדמות חיה של סנכרון, ייבוא, שינויי קבוצות ופעולות מרוכזות נוספות.",
  jobs_title: "עבודות רקע",
  jobs_intro:
    "פעילות עמידה לאתחול לפי משתמש ותחנה. כשל בתחנה אחת אינו מסתיר את התקדמות שאר התחנות.",
  jobs_summary: "סיכום עבודות",
  jobs_kind: "סוג פעולה",
  job_kind_all: "כל הפעולות",
  job_kind_sync: "סנכרון",
  job_kind_bulk: "שינויים מרוכזים",
  job_kind_csv: "ייבוא CSV",
  jobs_progress: "התקדמות מאומתת",
  jobs_retry_user: "נסה שוב למשתמש",
  jobs_retry_station: "נסה שוב לתחנה",
  jobs_details: "פירוט משתמשים ותחנות",
  jobs_empty: "אין עבודות התואמות למסננים.",
  job_action_sync_user_station: "סנכרון משתמש",
  job_action_bulk_csv_import: "ייבוא CSV",
  tools_audit: "סקירת פעולות ניהול ותוצאותיהן.",
