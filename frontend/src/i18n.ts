const en = {
  call_compact_hint: "Call controls only. Two-way audio is not available yet.",
  ...
  media_signal_hint:
    "These buttons control call signaling only. Two-way audio is not connected. Acknowledgement is not confirmation of audio or an answered call.",
...
const he: Record<keyof typeof en, string> = {
  call_compact_hint: "בקרת שיחה בלבד. שמע דו־כיווני עדיין אינו זמין.",
  ...
  media_signal_hint:
    "כפתורים אלה שולטים באיתות השיחה בלבד. שמע דו־כיווני טרם מחובר. אישור הפקודה אינו מאמת שמע או מענה.",
